    ...
    <div className="detail">
      ...
      <div className="detailTop">
        ...
        <span className="detailDate">
          {" "}
          (기간 : {post.startDay}~{post.endDay})
        </span>
        <br />
        <br />
        <span className="detailWriter">
          {post.writer} ㅣ {post.created_at}
        </span>
        <br />
        <br />
      </div>
      ...
      <div className="detailbtns">
        ...
        <Link to="/doc">
          <button
            onClick={() => APIService.DeletePost(post.id, token["mytoken"])}
            className="detailBtnDelete"
          >
            삭제
          </button>
        </Link>
